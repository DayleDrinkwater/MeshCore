...
void CommonCLI::loadPrefsInt(FILESYSTEM* fs, const char* filename) {
  ...
  if (file) {
    ...
    file.read((uint8_t *)&_prefs->bq_chg_vreg_mv, sizeof(_prefs->bq_chg_vreg_mv));               // 170
    file.read((uint8_t *)&_prefs->bq_chg_current_ma, sizeof(_prefs->bq_chg_current_ma));         // 172
    file.read((uint8_t *)&_prefs->bq_prechg_current_ma, sizeof(_prefs->bq_prechg_current_ma));   // 174
    file.read((uint8_t *)&_prefs->bq_term_current_ma, sizeof(_prefs->bq_term_current_ma));       // 176
    file.read((uint8_t *)&_prefs->bq_rechg_threshold_mv, sizeof(_prefs->bq_rechg_threshold_mv)); // 178
    file.read((uint8_t *)&_prefs->bq_input_voltage_mv, sizeof(_prefs->bq_input_voltage_mv));     // 180
    file.read((uint8_t *)&_prefs->bq_input_current_ma, sizeof(_prefs->bq_input_current_ma));     // 182
    file.read((uint8_t *)&_prefs->bq_min_sys_voltage_mv, sizeof(_prefs->bq_min_sys_voltage_mv)); // 184
    file.read((uint8_t *)&_prefs->bq_vbat_uvlo, sizeof(_prefs->bq_vbat_uvlo));                   // 186
    // 187
...
void CommonCLI::savePrefs(FILESYSTEM* fs) {
  ...
  if (file) {
    ...
    file.write((uint8_t *)&_prefs->bq_chg_vreg_mv, sizeof(_prefs->bq_chg_vreg_mv));               // 170
    file.write((uint8_t *)&_prefs->bq_chg_current_ma, sizeof(_prefs->bq_chg_current_ma));         // 172
    file.write((uint8_t *)&_prefs->bq_prechg_current_ma, sizeof(_prefs->bq_prechg_current_ma));   // 174
    file.write((uint8_t *)&_prefs->bq_term_current_ma, sizeof(_prefs->bq_term_current_ma));       // 176
    file.write((uint8_t *)&_prefs->bq_rechg_threshold_mv, sizeof(_prefs->bq_rechg_threshold_mv)); // 178
    file.write((uint8_t *)&_prefs->bq_input_voltage_mv, sizeof(_prefs->bq_input_voltage_mv));     // 180
    file.write((uint8_t *)&_prefs->bq_input_current_ma, sizeof(_prefs->bq_input_current_ma));     // 182
    file.write((uint8_t *)&_prefs->bq_min_sys_voltage_mv, sizeof(_prefs->bq_min_sys_voltage_mv)); // 184
    file.write((uint8_t *)&_prefs->bq_vbat_uvlo, sizeof(_prefs->bq_vbat_uvlo));                   // 186
    // 187
